...
tablesPath = '/hdd/ReposPesados/SaliencyADHD/notebooks/results/';
setwd(tablesPath)
# averaged NSS
#DAVG <- readDataTable(tablesPath, paste(video, '/FinalTableH3b', video , '.csv', sep=""))

tableFile = '/FinalTableH3b';
tableFile = '/table_Diary_500'
DAVG <- readDataTable(tablesPath, paste(tableFile, video , '.csv', sep=""))
